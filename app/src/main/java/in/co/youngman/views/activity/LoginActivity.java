...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedpreferences = getSharedPreferences("AccessToken",
            ...
            call.enqueue(new Callback<AccessToken>() {
                ...
                public void onResponse(Call<AccessToken> call, Response<AccessToken> response) {
                    ...
                    if(response.code() == 200){
                        ...
                        SharedPreferences pref = getApplicationContext().getSharedPreferences("AccessToken", MODE_PRIVATE);
                        SharedPreferences.Editor editor = pref.edit();
                        editor.putString("token_type", "Bearer"); // Storing boolean - true/false
