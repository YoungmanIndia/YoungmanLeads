...
import in.co.youngman.adapters.DealsAdapter;
 ...
 */
public class DealsFragment extends Fragment implements LeadsInterfaceMVP.View, View.OnClickListener{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        createLeadsAPI();
        leadsAPI.getDeals().enqueue(leadsCallback);
    }
    ...
    public void getLeads(List<Leads> data) {
        recyclerView.setAdapter(new DealsAdapter(data, getContext()));
    }
